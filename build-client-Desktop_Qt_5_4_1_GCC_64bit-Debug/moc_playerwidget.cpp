...
#include "../client/ui/playerwidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PlayerWidget_t, stringdata) + ofs \
...
void *PlayerWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PlayerWidget.stringdata))
