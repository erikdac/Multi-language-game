...
#include "../client/ui/gameengine/enginewidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_EngineWidget_t, stringdata) + ofs \
...
const QMetaObject EngineWidget::staticMetaObject = {
    { &StackedWidget::staticMetaObject, qt_meta_stringdata_EngineWidget.data,
      qt_meta_data_EngineWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *EngineWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_EngineWidget.stringdata))
