...
#include "../client/ui/gameengine/glwidget.h"
...
QT_MOC_LITERAL(1, 9, 7), // "repaint"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 4) // "done"

    },
    "GLWidget\0repaint\0\0done"
};
...
void GLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GLWidget::repaint)) {
                *result = 0;
            }
        }
        {
            typedef void (GLWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GLWidget::done)) {
                *result = 1;
            }
        }
    }
