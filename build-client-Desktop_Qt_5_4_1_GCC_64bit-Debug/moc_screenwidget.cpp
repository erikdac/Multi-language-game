...
#include "../client/ui/screenwidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ScreenWidget_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 22, 4) // "done"

    },
    "ScreenWidget\0repaint\0\0done"
};
...
void ScreenWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ScreenWidget::repaint)) {
                *result = 0;
            }
        }
        {
            typedef void (ScreenWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ScreenWidget::done)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject ScreenWidget::staticMetaObject = {
    { &QOpenGLWidget::staticMetaObject, qt_meta_stringdata_ScreenWidget.data,
...
void *ScreenWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ScreenWidget.stringdata))
...
// SIGNAL 0
void ScreenWidget::repaint()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void ScreenWidget::done()
{
